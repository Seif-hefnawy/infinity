...
export default function FallingRoses() {
  ...
  useEffect(() => {
    // Legitimate client-only-mount pattern (avoids SSR/CSR hydration
    // mismatch for a purely decorative, randomized animation) - not a case
    // the "derive state instead of syncing" guidance applies to.
